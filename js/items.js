...
"Why don't you take a minute and enjoy your morning coffee or tea.", 
...
"If something keeps breaking down, it's time to move on and replace it.",
"As long as your memories are pure, any loved one you may have lost is never lost.",
"The one thing money can't buy is pure happiness.",
"Real friends treat you unconditionally with love and respect.",
"Learning from histories greatest mistakes will help you avoid repeating them.",
"Solving problems together is a sign of strength, not weakness.",
"You will make someone feel appreciated today.",
"Your work week will be filled with lots of challenges and problems to deal with, but your intelligence will get you through them.",
"Good news is around the corner.  Don't give up hope.",
"It doesn't hurt to apologize to someone you hurt in the past.  Clearing your conscience will also make you feel better.",
"Never underestimate the power of love.",
"If you feel like someone has taken control of your life, others are there to help.",
"Don't feel threatened by those who appear superior.  Embrace the challenge.",
"You can make a difference.  Speak up if you feel something is not right.",
"Don’t focus on small issues.  Choose your battles wisely.",
"Don’t encourage bad behavior, even if you feel that you’re outnumbered.",
"Your life is not in someone else’s control.  You have the power to make a change for the better.",
"This week would be a great time to donate blood.",
"Resilience should be your theme of the month at home and at work.",
"Your life is not in danger.  Don’t feel threatened by anyone or anything.",
"Eating too much is never a good idea, but physically and mentally.",
"Always make sure to spend at least 30 minutes a day to reflect.",
"You will be at your best when you slow down and make sure you’re making the right choice.",
"Consider going somewhere you've never thought of going.  You may be surprised.",
"Whenever you don’t feel loved or just need a hug when no one's around, give a tree a hug.",
"The key to life is having a healthy balance.  Too much of anything can cause problems.",
"The next time you squish a bug, just remember.  It has a purpose in this world.",
"When life is hard for you, take a step back and re-evaluate the problem.",
"The toughest decisions in life are also the most rewarding.",
"Your humbleness will get you rewarded when you least expect it.",
"Sometimes the easiest solution is to restart the thought process.",
"Gaining experience doesn't require having all the talent.",
"There's nothing wrong with sucking at something at first. Don't get discouraged.",
"Too get to the top, you must start at the bottom.",
"In some instances, all you need is chance to succeed."
];
